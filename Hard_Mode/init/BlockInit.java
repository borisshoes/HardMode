...
import Hard_Mode.objects.blocks.machines.BlockForbiddenEnchantingTable;
...
public class BlockInit {
	...
	public static final Block HELLISH_BRICK = new BlockBase("hellish_brick", Material.ROCK, 2.0F, 15.0F, 1, "pickaxe", SoundType.STONE);
	public static final Block HEAVENLY_BRICK = new BlockBase("heavenly_brick", Material.ROCK, 3.0F, 15.0F, 1, "pickaxe", SoundType.STONE);
	public static final Block TERRAN_BRICK = new BlockBase("terran_brick", Material.ROCK, 2.5F, 15.0F, 1, "pickaxe", SoundType.STONE);
	
	public static final Block FORBIDDEN_ENCHANTING_TABLE = new BlockForbiddenEnchantingTable("forbidden_enchanting_table", Material.ROCK, 15.0F, 2000.0F, 3, "pickaxe", SoundType.STONE);
