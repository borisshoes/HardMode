...
public class BlockHellfireFurnace extends BlockBase implements ITileEntityProvider{
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(BlockInit.HELLFIRE_FURNACE);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(BlockInit.HELLFIRE_FURNACE);
	}
	
	@Override
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if(!worldIn.isRemote) {
			playerIn.openGui(HardMode.instance, ConfigHandler.GUI_HELLFIRE_FURNACE, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	...
	public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
		if(!worldIn.isRemote) {
			...
			else if(face == EnumFacing.SOUTH && north.isFullBlock() && !north.isFullBlock()) face = EnumFacing.NORTH;
			else if(face == EnumFacing.EAST && north.isFullBlock() && !west.isFullBlock()) face = EnumFacing.WEST;
			else if(face == EnumFacing.WEST && north.isFullBlock() && !east.isFullBlock()) face = EnumFacing.EAST;
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityHellfireFurnace();
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityHellfireFurnace tileentity = (TileEntityHellfireFurnace)worldIn.getTileEntity(pos);
