...
public class ContainerInfernoBox extends Container /*extends ContainerFurnace*/{
    ...
    public ContainerInfernoBox(InventoryPlayer playerInventory, IInventory furnaceInventory, EntityPlayer player)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
        this.addSlotToContainer(new SlotFurnaceFuel(furnaceInventory, 1, 56, 53));
        this.addSlotToContainer(new SlotFurnaceOutput(player, furnaceInventory, 2, 116, 35));
    ...
    public void onContainerClosed(EntityPlayer playerIn)
    {
        ...
        this.tileFurnace.closeInventory(playerIn);
    }
    
	//public ContainerInfernoBox(InventoryPlayer playerInventory, IInventory furnaceInventory) {
